...
var bdate=new Date();
var dd=bdate.getUTCDate();
var mm=bdate.getUTCMonth();
var yyyy=bdate.getUTCFullYear();
var xyz= yyyy+"-"+mm+"-"+dd;
console.log("hel",req.body)
var tdate=new Date(req.body.traveldate);
var dd=tdate.getUTCDate();
var mm=tdate.getUTCMonth();
var yyyy=tdate.getUTCFullYear();
var xyz2= 2023+"-"+12+"-"+10;
...
var lon=9292394.3432
    // console.log(st.slice(10,0));
    
 
        console.log(`insert into Through values(${rid},${did},${st},'${0}',${pnr})`)
...
app.post('/driver', async (req, res) => {
  ...
  var date_of_join = req.body.date_of_join.slice(0,10);
